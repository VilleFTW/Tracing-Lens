...
/* harmony import */ var _framework_delegate_0d4f56b1_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-0d4f56b1.js */ 34043);
/* harmony import */ var _helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-1ec1a6dd.js */ 31435);
/* harmony import */ var _keyboard_4d5544a0_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./keyboard-4d5544a0.js */ 96524);
/* harmony import */ var _index_9ac92660_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-9ac92660.js */ 2141);
/* harmony import */ var _overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-1159a357.js */ 96158);
...
/* harmony import */ var _animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./animation-968c84bb.js */ 11467);
/* harmony import */ var _cubic_bezier_c313947a_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./cubic-bezier-c313947a.js */ 41077);
/* harmony import */ var _index_3f1a7d95_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-3f1a7d95.js */ 82172);
...
/* harmony import */ var _gesture_controller_17e82006_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./gesture-controller-17e82006.js */ 70607);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref = (0,C_Users_bsori_Documents_GitHub_tracing_eye_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = detail => {
    ...
    const clampedStep = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0.0001, processedStep, maxStep);
...
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  ...
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const baseAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    const isMobile = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  return (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  return (0,_animation_968c84bb_js__WEBPACK_IMPORTED_MODULE_10__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
};
...
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], getCurrentBreakpoint, onDismiss, onBreakpointChange) => {
  ...
  const onMove = detail => {
    ...
    offset = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_4__.k)(0.0001, processedStep, maxStep);
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.ionBreakpointDidChange = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.e)(this, "ionBreakpointDidChange", 7);
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  connectedCallback() {
    (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.e)(this.el);
  }
  ...
  present() {
    ...
    return (0,C_Users_bsori_Documents_GitHub_tracing_eye_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_0d4f56b1_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, _this2.el, _this2.component, ['ion-page'], data, inline);
      yield (0,_index_c71f6940_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
      (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this2.el.classList.add('show-modal'));
      _this2.currentTransition = (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.d)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
        presentingEl: _this2.presentingElement,
      ...
      } else if (_this2.swipeToClose || _this2.canDismiss !== undefined && _this2.presentingElement !== undefined) {
      ...
      if (typeof window !== 'undefined') {
        ...
        window.addEventListener(_keyboard_4d5544a0_js__WEBPACK_IMPORTED_MODULE_5__.KEYBOARD_DID_OPEN, _this2.keyboardOpenCallback);
      }
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,C_Users_bsori_Documents_GitHub_tracing_eye_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
  ...
  dismiss(data, role) {
    ...
    return (0,C_Users_bsori_Documents_GitHub_tracing_eye_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (role !== 'handler' && !(yield _this5.checkCanDismiss())) {
        return false;
      }
      /* tslint:disable-next-line */
      ...
      if (typeof window !== 'undefined' && _this5.keyboardOpenCallback) {
        window.removeEventListener(_keyboard_4d5544a0_js__WEBPACK_IMPORTED_MODULE_5__.KEYBOARD_DID_OPEN, _this5.keyboardOpenCallback);
      }
      /**
       * When using an inline modal
      ...
      const enteringAnimation = _overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.h.get(_this5) || [];
      _this5.currentTransition = (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: _this5.presentingElement,
        currentBreakpoint: _this5.currentBreakpoint || _this5.initialBreakpoint,
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_0d4f56b1_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
        (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.c)(() => _this5.el.classList.remove('show-modal'));
  ...
  onDidDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionModalDidDismiss');
  }
  /**
  ...
  onWillDismiss() {
    return (0,_overlays_1159a357_js__WEBPACK_IMPORTED_MODULE_7__.g)(this.el, 'ionModalWillDismiss');
  }
  /**
