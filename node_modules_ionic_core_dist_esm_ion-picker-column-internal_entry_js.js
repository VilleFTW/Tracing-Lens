...
/* harmony import */ var _haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./haptic-683b3b3c.js */ 83750);
...
const PickerColumnInternal = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
      ...
      const scrollCallback = () => {
        (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => {
          if (timeout) {
  ...
  componentWillLoad() {
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
        ...
        const oldActive = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.${PICKER_COL_ACTIVE}`);
  ...
  get activeItem() {
    return (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.g)(this.el).querySelector(`.picker-item[data-value="${this.value}"]`);
  }
