...
const PickerInternal = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  render() {
    return ((0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.H, { onPointerDown: (ev) => this.onPointerDown(ev), onClick: () => this.onClick() }, (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("input", { "aria-hidden": "true", tabindex: -1, inputmode: "numeric", type: "number", ref: (el) => (this.inputEl = el), onInput: () => this.onInputChange(), onBlur: () => this.exitInputMode() }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-before" }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-after" }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "picker-highlight", ref: (el) => (this.highlightEl = el) }), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_0__.h)("slot", null)));
  }
