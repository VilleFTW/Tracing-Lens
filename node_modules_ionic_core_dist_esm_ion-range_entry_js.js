...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionKnobMoveStart = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.e)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.e)(this, "ionKnobMoveEnd", 7);
    this.didLoad = false;
    this.noUpdate = false;
    this.hasFocus = false;
    ...
    this.clampBounds = value => {
      return (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Users_bsori_Documents_GitHub_tracing_eye_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, this.ratioB + step, 1);
      }
  ...
  onStart(detail) {
    ...
    let ratio = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, (currentX - rect.left) / rect.width, 1);
  ...
  render() {
    ...
    let {
      labelText
    } = (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.d)(el, rangeId);
    ...
    (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    ...
    }, ticks.map(tick => (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_b3eecb14_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(min, value, max);
};

const valueToRatio = (value, min, max) => {
  return (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_3__.k)(0, (value - min) / (max - min), 1);
};
